...
public record StrategyProperties(
		...
		boolean enableRegimeProtectionMode,
		int regimeProtectionBars,
		double regimeSetup4ChaseEma20DistPct,
		boolean enableRegimeRiskPresets,
		double regimeBaseTakeProfitBps,
		double regimeBaseStopLossBps,
		int regimeChopTimeStopBars,
		int regimeTrendTimeStopBars,
		int regimeBreakoutTimeStopBars,
		int regimeMeanRevTimeStopBars,
		double regimeTrendTpMult,
		double regimeTrendSlMult,
		double regimeBreakoutTp1Mult,
		double regimeBreakoutTp2Mult,
		double regimeBreakoutSlMult,
		double regimeMeanRevTpMult,
		double regimeMeanRevSlMult,
